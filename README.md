...
Ayuda al equipo de marketing de una escuela online a crear su propia sistema de analítica integral para entender de dónde vienen los estudiantes y qué canales realmente impulsan las ventas.
...
```bash
git clone https://github.com/SilviaPalencia/data-analyst-project-279.git
cd data-analyst-project-279
```
